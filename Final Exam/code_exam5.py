...
class edx(object):
    ...
    def setGrade(self, grade, course="6.01x"):
        """
        grade: integer greater than or equal to 0 and less than or equal to 100 (grade>=0 and grade<=100)
        course: string 
        ...
        for co in self.myCourses:
            if course==co.courseName:
                co.setGrade(grade)
